...
const PRODUCTS = [
  { id:1, cat:"Living Room", name:"Arc Sofa", mat:"Italian Linen", price:2400, tag:"Bestseller", desc:"Clean lines, deep comfort. Crafted in solid walnut with hand-stitched upholstery. Available in 3 widths.", dims:"W220 × D90 × H75 cm", img:"sofa", colors:[{n:"Sand",h:"#C9B99A"},{n:"Slate",h:"#6B6B6B"},{n:"Onyx",h:"#2C2C2C"},{n:"Ivory",h:"#E8E0D5"}], sizes:["2-Seater","3-Seater","Corner L-Shape"] },
  ...
  { id:5, cat:"Living Room", name:"Void Shelf", mat:"Powder-coated Steel", price:890, tag:"New", desc:"Wall-mounted open shelving system. Brutally simple, endlessly functional. Modular — add units as you grow.", dims:"W120 × D30 × H180 cm", img:"shelf", colors:[{n:"Onyx",h:"#2C2C2C"},{n:"Sand",h:"#C9B99A"},{n:"Slate",h:"#6B6B6B"}], sizes:["3 Shelves","5 Shelves","7 Shelves"] },
  ...
  { id:7, cat:"Dining", name:"Form Chair", mat:"Molded Plywood", price:380, tag:"Custom", desc:"A study in form. Bent plywood, one continuous curve, zero joints. Stackable up to 6 high.", dims:"W45 × D50 × H80 cm", img:"chair", colors:[{n:"Natural",h:"#C9B99A"},{n:"Walnut",h:"#8B6F5C"},{n:"Onyx",h:"#2C2C2C"}], sizes:["Armless","With Arms"] },
  { id:8, cat:"Office", name:"Mono Bookcase", mat:"Birch Ply + Steel", price:1100, tag:"Popular", desc:"Modular, expandable. Every configuration looks intentional. Mix open and closed compartments.", dims:"W90 × D35 × H220 cm", img:"bookcase", colors:[{n:"Ivory",h:"#E8E0D5"},{n:"Onyx",h:"#2C2C2C"},{n:"Walnut",h:"#8B6F5C"}], sizes:["Half Height 120cm","Full Height 220cm","Wide 160cm"] },
  { id:9, cat:"Living Room", name:"Stone Coffee Table", mat:"Travertine + Brass", price:1600, tag:"New", desc:"Travertine top with polished brass base. Every stone is unique — no two tables are the same.", dims:"W120 × D60 × H40 cm", img:"table", colors:[{n:"Travertine",h:"#D4C4B0"},{n:"Nero",h:"#2C2C2C"},{n:"Cream",h:"#F0EAE0"}], sizes:["Small 90cm","Medium 120cm","Large 150cm"] },
...
function ProductCard({ p, onClick }) {
  ...
  return (
    <div className="card" onClick={onClick}>
      <div style={{ height: 230, background: "#FAF8F5", display: "flex", alignItems: "center", justifyContent: "center", padding: 38, position: "relative" }}>
        <FurnitureSVG type={p.img} color={p.colors[0].h} />
...
function Catalog({ go }) {
  ...
  const cats = ["All","Living Room","Bedroom","Dining","Office"];
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(250px,1fr))", gap: 20 }}>
          {list.map(p => (
            <div key={p.id} className="card" onClick={() => { setSel(p); setSc(0); setSs(0); }}>
              <div style={{ height: 220, background: "#FAF8F5", display: "flex", alignItems: "center", justifyContent: "center", padding: 36, position: "relative" }}>
                <FurnitureSVG type={p.img} color={p.colors[0].h} />
      ...
      {sel && <>
        ...
        <div className="mo">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
            <div style={{ background: "#FAF8F5", padding: 52, display: "flex", alignItems: "center", justifyContent: "center", minHeight: 440 }}>

...
const PRODUCTS = [
  ...
  { id:20, cat:"Bedroom", name:"Walnut Double Dresser", mat:"Solid Dark Walnut", price:400, tag:"Bestseller", desc:"Six drawers in two columns, handleless push-to-open design. Rich dark walnut grain makes every piece one of a kind. Built solid, built to last a lifetime.", dims:"W140 × D45 × H80 cm", img:"bookcase", colors:[{n:"Dark Walnut",h:"#5C3D2E",photo:"/dresser-walnut-double.jpg"}], sizes:["Standard 140cm","Wide 160cm"] },
  { id:21, cat:"Bedroom", name:"Walnut Low Dresser", mat:"Solid Walnut", price:400, tag:"New", desc:"Low and wide with tapered legs and round wood knobs. A mid-century soul with a modern edge. Perfect as a dresser or a statement sideboard.", dims:"W120 × D45 × H65 cm", img:"nightstand", colors:[{n:"Walnut",h:"#8B6F5C",photo:"/dresser-walnut-low.jpg"}], sizes:["Standard 120cm","Wide 140cm"] },
  { id:22, cat:"Bedroom", name:"Walnut Mid Dresser", mat:"Solid Walnut", price:400, tag:"Popular", desc:"Three deep drawers with recessed cut handles. Clean, sculptural, no excess. The wood grain does all the talking.", dims:"W90 × D45 × H75 cm", img:"nightstand", colors:[{n:"Walnut",h:"#8B6F5C",photo:"/dresser-walnut-mid.jpg"}], sizes:["Standard 90cm","Wide 110cm"] },
  { id:23, cat:"Bedroom", name:"Ash Wide Dresser", mat:"Solid Ash + Brass", price:400, tag:"Custom", desc:"Three wide drawers with brushed brass bar handles. Light ash wood with a warm golden tone. Styled with a vase on top — as it should be.", dims:"W130 × D45 × H75 cm", img:"bookcase", colors:[{n:"Natural Ash",h:"#C9A96E",photo:"/dresser-ash.jpg"}], sizes:["Standard 130cm","Wide 150cm"] },
  { id:24, cat:"Bedroom", name:"Oak Grand Dresser", mat:"Solid Oak + Brass", price:400, tag:"Popular", desc:"Six drawers, two columns, brass bar handles. A grand dresser with a timeless silhouette. Solid oak on tapered legs — bedroom furniture that becomes an heirloom.", dims:"W150 × D45 × H80 cm", img:"bookcase", colors:[{n:"Natural Oak",h:"#C9A96E",photo:"/dresser-oak.jpg"}], sizes:["Standard 150cm","Wide 170cm"] },
];
